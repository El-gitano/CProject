...
begin
	...
	bdd.execute "CREATE TABLE IF NOT EXISTS grillejouee(id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, joueur INTEGER NOT NULL REFERENCES profil(id), nomgrille VARCHAR NOT NULL, taillegrille INTEGER NOT NULL, grille BLOB NOT NULL, jokersRestants INTEGER NT NULL,timer INTEGER NOT NULL, datedebut DATE NOT NULL)"
