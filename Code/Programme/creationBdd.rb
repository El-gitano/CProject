...
begin
    ...
    bdd.execute "CREATE TABLE IF NOT EXISTS grilleediter(id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, createur INTEGER NOT NULL REFERENCES profil(id), nomgrille VARCHAR NOT NULL, taillegrille INTEGER NOT NULL, grille BLOB NOT NULL, nbjokers INTEGER NT NULL)"
